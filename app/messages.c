...
//     { MSG_TYPE_SUCCESS, TYPE_ADD_GROUP_LIGHT, MSG_ADD_GROUP_SUCCESS },
//     { MSG_TYPE_FAILED, TYPE_ADD_GROUP_LIGHT, MSG_ADD_GROUP_FAILED },
...
static request_msg_t g_messageRequests[] = {
    { TYPE_ADD_GROUP_LIGHT, MSG_ADD_GROUP_NORMAL },
    { TYPE_UPDATE_GROUP_LIGHT, MSG_UPDATE_GROUP_NORMAL },
    { TYPE_ADD_GROUP_LIGHT, MSG_ADD_GROUP_LINK },
    { TYPE_UPDATE_GROUP_LIGHT, MSG_UPDATE_GROUP_LINK },
};
