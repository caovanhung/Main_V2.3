...
all : HG_APPLICATION_SERVICES_AWS HG_CORE_SERVICES_COREDATA HG_DEVICE_SERVICES_BLE HG_DEVICE_SERVICES_WIFI
...
HG_CORE_SERVICES_COREDATA: main_CoreService_Coredata.o ble_process.o uart.o database.o sqlite3.o time_t.o queue.o parson.o core_process_t.o mosquitto.o core_data_process.o helper.o messages.o cJSON.o
	$(CC)	main_CoreService_Coredata.o ble_process.o uart.o database.o sqlite3.o time_t.o queue.o parson.o  core_process_t.o mosquitto.o core_data_process.o helper.o messages.o cJSON.o -lm -o HG_CORE_SERVICES_COREDATA $(CFLAGS)
