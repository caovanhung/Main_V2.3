...
HG_CORE: app/main_core.o app/database.o lib/sqlite3.o lib/time_t.o lib/queue.o lib/parson.o lib/core_process_t.o app/aws_mosquitto.o lib/helper.o app/messages.o lib/cJSON.o app/core_api.o
	$(CC)   app/main_core.o app/database.o lib/sqlite3.o lib/time_t.o lib/queue.o lib/parson.o  lib/core_process_t.o app/aws_mosquitto.o lib/helper.o app/messages.o lib/cJSON.o app/core_api.o -lm -o HG_CORE $(CFLAGS)
